...
<table id="content" border="0" cellspacing="0">
  <tr>
	...
	<h1>WAR Interface Modifications</h1>
	<p>When Mythic has released initial information regarding the options available for creating UI mods and addons, WARGuilds plans to be the 
	primary resource for players and guilds to coordinate their coolest interface ever!</p>
	</td>
